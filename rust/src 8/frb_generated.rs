...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 665378218;
...
101 => wire__crate__api__message__OneshotNotify_send_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__message_port__MessagePort_clear_onmessage_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__message_port__MessagePort_post_message_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__message_port__MessagePort_set_onmessage_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__node__analyser__AnalyserNode_fft_size_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__node__analyser__AnalyserNode_frequency_bin_count_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__node__analyser__AnalyserNode_get_byte_frequency_data_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__node__analyser__AnalyserNode_get_byte_time_domain_data_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__node__analyser__AnalyserNode_get_float_frequency_data_impl(port, ptr, rust_vec_len, data_len),
110 => wire__crate__api__node__analyser__AnalyserNode_get_float_time_domain_data_impl(port, ptr, rust_vec_len, data_len),
111 => wire__crate__api__node__analyser__AnalyserNode_max_decibels_impl(port, ptr, rust_vec_len, data_len),
112 => wire__crate__api__node__analyser__AnalyserNode_min_decibels_impl(port, ptr, rust_vec_len, data_len),
113 => wire__crate__api__node__analyser__AnalyserNode_new_impl(port, ptr, rust_vec_len, data_len),
114 => wire__crate__api__node__analyser__AnalyserNode_set_fft_size_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__node__analyser__AnalyserNode_set_max_decibels_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__node__analyser__AnalyserNode_set_min_decibels_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__node__analyser__AnalyserNode_set_smoothing_time_constant_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__node__analyser__AnalyserNode_smoothing_time_constant_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_buffer_impl(port, ptr, rust_vec_len, data_len),
120 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_detune_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_loop__impl(port, ptr, rust_vec_len, data_len),
122 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_loop_end_impl(port, ptr, rust_vec_len, data_len),
123 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_loop_start_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_new_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_playback_rate_impl(port, ptr, rust_vec_len, data_len),
126 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_position_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_set_buffer_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_set_loop_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_set_loop_end_impl(port, ptr, rust_vec_len, data_len),
130 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_set_loop_start_impl(port, ptr, rust_vec_len, data_len),
131 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_start_at_with_offset_impl(port, ptr, rust_vec_len, data_len),
132 => wire__crate__api__node__audio_buffer_source__AudioBufferSourceNode_start_at_with_offset_and_duration_impl(port, ptr, rust_vec_len, data_len),
133 => wire__crate__api__node__biquad_filter__BiquadFilterNode_detune_impl(port, ptr, rust_vec_len, data_len),
134 => wire__crate__api__node__biquad_filter__BiquadFilterNode_frequency_impl(port, ptr, rust_vec_len, data_len),
135 => wire__crate__api__node__biquad_filter__BiquadFilterNode_gain_impl(port, ptr, rust_vec_len, data_len),
136 => wire__crate__api__node__biquad_filter__BiquadFilterNode_get_frequency_response_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__node__biquad_filter__BiquadFilterNode_new_impl(port, ptr, rust_vec_len, data_len),
138 => wire__crate__api__node__biquad_filter__BiquadFilterNode_q_impl(port, ptr, rust_vec_len, data_len),
139 => wire__crate__api__node__biquad_filter__BiquadFilterNode_set_type_impl(port, ptr, rust_vec_len, data_len),
140 => wire__crate__api__node__biquad_filter__BiquadFilterNode_type__impl(port, ptr, rust_vec_len, data_len),
141 => wire__crate__api__node__channel_merger__ChannelMergerNode_new_impl(port, ptr, rust_vec_len, data_len),
142 => wire__crate__api__node__channel_splitter__ChannelSplitterNode_new_impl(port, ptr, rust_vec_len, data_len),
143 => wire__crate__api__node__constant_source__ConstantSourceNode_new_impl(port, ptr, rust_vec_len, data_len),
144 => wire__crate__api__node__constant_source__ConstantSourceNode_offset_impl(port, ptr, rust_vec_len, data_len),
145 => wire__crate__api__node__convolver__ConvolverNode_buffer_impl(port, ptr, rust_vec_len, data_len),
146 => wire__crate__api__node__convolver__ConvolverNode_new_impl(port, ptr, rust_vec_len, data_len),
147 => wire__crate__api__node__convolver__ConvolverNode_normalize_impl(port, ptr, rust_vec_len, data_len),
148 => wire__crate__api__node__convolver__ConvolverNode_set_buffer_impl(port, ptr, rust_vec_len, data_len),
149 => wire__crate__api__node__convolver__ConvolverNode_set_normalize_impl(port, ptr, rust_vec_len, data_len),
150 => wire__crate__api__node__delay__DelayNode_delay_time_impl(port, ptr, rust_vec_len, data_len),
151 => wire__crate__api__node__delay__DelayNode_new_impl(port, ptr, rust_vec_len, data_len),
152 => wire__crate__api__node__destination__AudioDestinationNode_max_channel_count_impl(port, ptr, rust_vec_len, data_len),
153 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_attack_impl(port, ptr, rust_vec_len, data_len),
154 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_knee_impl(port, ptr, rust_vec_len, data_len),
155 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_new_impl(port, ptr, rust_vec_len, data_len),
156 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_ratio_impl(port, ptr, rust_vec_len, data_len),
157 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_reduction_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_release_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__node__dynamics_compressor__DynamicsCompressorNode_threshold_impl(port, ptr, rust_vec_len, data_len),
160 => wire__crate__api__node__gain__GainNode_gain_impl(port, ptr, rust_vec_len, data_len),
161 => wire__crate__api__node__gain__GainNode_new_impl(port, ptr, rust_vec_len, data_len),
162 => wire__crate__api__node__iir_filter__IirFilterNode_get_frequency_response_impl(port, ptr, rust_vec_len, data_len),
163 => wire__crate__api__node__iir_filter__IirFilterNode_new_impl(port, ptr, rust_vec_len, data_len),
164 => wire__crate__api__node__media_element_source__MediaElementAudioSourceNode_new_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__node__media_stream_destination__MediaStreamAudioDestinationNode_new_impl(port, ptr, rust_vec_len, data_len),
166 => wire__crate__api__node__media_stream_destination__MediaStreamAudioDestinationNode_stream_impl(port, ptr, rust_vec_len, data_len),
167 => wire__crate__api__node__media_stream_source__MediaStreamAudioSourceNode_new_impl(port, ptr, rust_vec_len, data_len),
168 => wire__crate__api__node__media_stream_track_source__MediaStreamTrackAudioSourceNode_new_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__node__oscillator__OscillatorNode_detune_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__node__oscillator__OscillatorNode_frequency_impl(port, ptr, rust_vec_len, data_len),
171 => wire__crate__api__node__oscillator__OscillatorNode_new_impl(port, ptr, rust_vec_len, data_len),
172 => wire__crate__api__node__oscillator__OscillatorNode_set_periodic_wave_impl(port, ptr, rust_vec_len, data_len),
173 => wire__crate__api__node__oscillator__OscillatorNode_set_type_impl(port, ptr, rust_vec_len, data_len),
174 => wire__crate__api__node__oscillator__OscillatorNode_type__impl(port, ptr, rust_vec_len, data_len),
175 => wire__crate__api__node__panner__PannerNode_cone_inner_angle_impl(port, ptr, rust_vec_len, data_len),
176 => wire__crate__api__node__panner__PannerNode_cone_outer_angle_impl(port, ptr, rust_vec_len, data_len),
177 => wire__crate__api__node__panner__PannerNode_cone_outer_gain_impl(port, ptr, rust_vec_len, data_len),
178 => wire__crate__api__node__panner__PannerNode_distance_model_impl(port, ptr, rust_vec_len, data_len),
179 => wire__crate__api__node__panner__PannerNode_max_distance_impl(port, ptr, rust_vec_len, data_len),
180 => wire__crate__api__node__panner__PannerNode_new_impl(port, ptr, rust_vec_len, data_len),
181 => wire__crate__api__node__panner__PannerNode_orientation_x_impl(port, ptr, rust_vec_len, data_len),
182 => wire__crate__api__node__panner__PannerNode_orientation_y_impl(port, ptr, rust_vec_len, data_len),
183 => wire__crate__api__node__panner__PannerNode_orientation_z_impl(port, ptr, rust_vec_len, data_len),
184 => wire__crate__api__node__panner__PannerNode_panning_model_impl(port, ptr, rust_vec_len, data_len),
185 => wire__crate__api__node__panner__PannerNode_position_x_impl(port, ptr, rust_vec_len, data_len),
186 => wire__crate__api__node__panner__PannerNode_position_y_impl(port, ptr, rust_vec_len, data_len),
187 => wire__crate__api__node__panner__PannerNode_position_z_impl(port, ptr, rust_vec_len, data_len),
188 => wire__crate__api__node__panner__PannerNode_ref_distance_impl(port, ptr, rust_vec_len, data_len),
189 => wire__crate__api__node__panner__PannerNode_rolloff_factor_impl(port, ptr, rust_vec_len, data_len),
190 => wire__crate__api__node__panner__PannerNode_set_cone_inner_angle_impl(port, ptr, rust_vec_len, data_len),
191 => wire__crate__api__node__panner__PannerNode_set_cone_outer_angle_impl(port, ptr, rust_vec_len, data_len),
192 => wire__crate__api__node__panner__PannerNode_set_cone_outer_gain_impl(port, ptr, rust_vec_len, data_len),
193 => wire__crate__api__node__panner__PannerNode_set_distance_model_impl(port, ptr, rust_vec_len, data_len),
194 => wire__crate__api__node__panner__PannerNode_set_max_distance_impl(port, ptr, rust_vec_len, data_len),
195 => wire__crate__api__node__panner__PannerNode_set_orientation_impl(port, ptr, rust_vec_len, data_len),
196 => wire__crate__api__node__panner__PannerNode_set_panning_model_impl(port, ptr, rust_vec_len, data_len),
197 => wire__crate__api__node__panner__PannerNode_set_position_impl(port, ptr, rust_vec_len, data_len),
198 => wire__crate__api__node__panner__PannerNode_set_ref_distance_impl(port, ptr, rust_vec_len, data_len),
199 => wire__crate__api__node__panner__PannerNode_set_rolloff_factor_impl(port, ptr, rust_vec_len, data_len),
200 => wire__crate__api__node__script_processor__ScriptProcessorNode_buffer_size_impl(port, ptr, rust_vec_len, data_len),
201 => wire__crate__api__node__script_processor__ScriptProcessorNode_clear_onaudioprocess_impl(port, ptr, rust_vec_len, data_len),
202 => wire__crate__api__node__script_processor__ScriptProcessorNode_new_impl(port, ptr, rust_vec_len, data_len),
203 => wire__crate__api__node__script_processor__ScriptProcessorNode_set_onaudioprocess_impl(port, ptr, rust_vec_len, data_len),
204 => wire__crate__api__node__stereo_panner__StereoPannerNode_new_impl(port, ptr, rust_vec_len, data_len),
205 => wire__crate__api__node__stereo_panner__StereoPannerNode_pan_impl(port, ptr, rust_vec_len, data_len),
206 => wire__crate__api__node__waveshaper__WaveShaperNode_curve_impl(port, ptr, rust_vec_len, data_len),
207 => wire__crate__api__node__waveshaper__WaveShaperNode_new_impl(port, ptr, rust_vec_len, data_len),
208 => wire__crate__api__node__waveshaper__WaveShaperNode_oversample_impl(port, ptr, rust_vec_len, data_len),
209 => wire__crate__api__node__waveshaper__WaveShaperNode_set_curve_impl(port, ptr, rust_vec_len, data_len),
210 => wire__crate__api__node__waveshaper__WaveShaperNode_set_oversample_impl(port, ptr, rust_vec_len, data_len),
211 => wire__crate__api__param__AudioParam_automation_rate_impl(port, ptr, rust_vec_len, data_len),
212 => wire__crate__api__param__AudioParam_cancel_and_hold_at_time_impl(port, ptr, rust_vec_len, data_len),
213 => wire__crate__api__param__AudioParam_cancel_scheduled_values_impl(port, ptr, rust_vec_len, data_len),
214 => wire__crate__api__param__AudioParam_default_value_impl(port, ptr, rust_vec_len, data_len),
215 => wire__crate__api__param__AudioParam_exponential_ramp_to_value_at_time_impl(port, ptr, rust_vec_len, data_len),
216 => wire__crate__api__param__AudioParam_linear_ramp_to_value_at_time_impl(port, ptr, rust_vec_len, data_len),
217 => wire__crate__api__param__AudioParam_max_value_impl(port, ptr, rust_vec_len, data_len),
218 => wire__crate__api__param__AudioParam_min_value_impl(port, ptr, rust_vec_len, data_len),
219 => wire__crate__api__param__AudioParam_set_automation_rate_impl(port, ptr, rust_vec_len, data_len),
220 => wire__crate__api__param__AudioParam_set_target_at_time_impl(port, ptr, rust_vec_len, data_len),
221 => wire__crate__api__param__AudioParam_set_value_impl(port, ptr, rust_vec_len, data_len),
222 => wire__crate__api__param__AudioParam_set_value_at_time_impl(port, ptr, rust_vec_len, data_len),
223 => wire__crate__api__param__AudioParam_set_value_curve_at_time_impl(port, ptr, rust_vec_len, data_len),
224 => wire__crate__api__param__AudioParam_value_impl(port, ptr, rust_vec_len, data_len),
225 => wire__crate__api__periodic_wave__PeriodicWave_new_impl(port, ptr, rust_vec_len, data_len),
226 => wire__crate__api__resampling__Resampler_new_impl(port, ptr, rust_vec_len, data_len),
227 => wire__crate__api__simple__greet_impl(port, ptr, rust_vec_len, data_len),
228 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
229 => wire__crate__api__simple__init_tau_core_impl(port, ptr, rust_vec_len, data_len),
230 => wire__crate__api__simple__rust_set_log_level_impl(port, ptr, rust_vec_len, data_len),
231 => wire__crate__api__simple__trace_logger_impl(port, ptr, rust_vec_len, data_len),
232 => wire__crate__api__spatial__AudioListenerNode_into_fields_impl(port, ptr, rust_vec_len, data_len),
233 => wire__crate__api__spatial__AudioListenerNode_new_impl(port, ptr, rust_vec_len, data_len),
234 => wire__crate__api__spatial__angle_impl(port, ptr, rust_vec_len, data_len),
235 => wire__crate__api__spatial__audio_listener_forward_x_impl(port, ptr, rust_vec_len, data_len),
236 => wire__crate__api__spatial__audio_listener_forward_y_impl(port, ptr, rust_vec_len, data_len),
237 => wire__crate__api__spatial__audio_listener_forward_z_impl(port, ptr, rust_vec_len, data_len),
238 => wire__crate__api__spatial__audio_listener_position_x_impl(port, ptr, rust_vec_len, data_len),
239 => wire__crate__api__spatial__audio_listener_position_y_impl(port, ptr, rust_vec_len, data_len),
240 => wire__crate__api__spatial__audio_listener_position_z_impl(port, ptr, rust_vec_len, data_len),
241 => wire__crate__api__spatial__audio_listener_up_x_impl(port, ptr, rust_vec_len, data_len),
242 => wire__crate__api__spatial__audio_listener_up_y_impl(port, ptr, rust_vec_len, data_len),
243 => wire__crate__api__spatial__audio_listener_up_z_impl(port, ptr, rust_vec_len, data_len),
244 => wire__crate__api__spatial__azimuth_and_elevation_impl(port, ptr, rust_vec_len, data_len),
245 => wire__crate__api__spatial__distance_impl(port, ptr, rust_vec_len, data_len),
246 => wire__crate__api__toto__toto_impl(port, ptr, rust_vec_len, data_len),
247 => wire__crate__api__toto__zozo_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
