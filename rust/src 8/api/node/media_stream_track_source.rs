...
use crate::api::media_streams::MediaStreamTrack;
...
pub struct MediaStreamTrackAudioSourceOptions<'a> {
    pub media_stream_track: RustAutoOpaque<&'a MediaStreamTrack>,
}
...
/// frame.  Use a [`MediaElementAudioSourceNode`](crate::api::node::MediaElementAudioSourceNode) for
