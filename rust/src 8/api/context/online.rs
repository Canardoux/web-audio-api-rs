...
use crate::api::context::{AudioContextState, BaseAudioContext, ConcreteBaseAudioContext};
use crate::api::events::{EventDispatch, EventHandler, EventLoop, EventPayload, EventType};
use crate::api::io::{self, AudioBackendManager, ControlThreadInit, NoneBackend, RenderThreadInit};
use crate::api::media_devices::{enumerate_devices_sync, MediaDeviceInfoKind};
use crate::api::media_streams::{MediaStream, MediaStreamTrack};
use crate::api::message::{ControlMessage, OneshotNotify};
use crate::api::node::{self, AudioNodeOptions};
use crate::api::render::graph::Graph;
use crate::api::media_element::MediaElement;
use crate::api::capacity::AudioRenderCapacity;
...
pub struct AudioContextOptions {
    ...
    /// power consumption.
    pub latency_hint: RustAutoOpaque<AudioContextLatencyCategory>,
    ...
    pub render_size_hint: RustAutoOpaque<AudioContextRenderSizeCategory>,
}
