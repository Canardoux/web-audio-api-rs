...
// The type `MediaElementAction` is not used by any `pub` functions, thus it is ignored.
// The type `RTSStream` is not used by any `pub` functions, thus it is ignored.

// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<P>>
@sealed
class P extends RustOpaque {
  P.dcoDecode(List<dynamic> wire) : super.dcoDecode(wire, _kStaticData);

  P.sseDecode(BigInt ptr, int externalSizeOnNative)
