...
// The type `IirFilterRenderer` is not used by any `pub` functions, thus it is ignored.
...
class IirFilterNode extends RustOpaque {
  IirFilterNode.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  IirFilterNode.sseDecode(BigInt ptr, int externalSizeOnNative)
  ...
  Future<void> getFrequencyResponse(
      ...
      RustLib.instance.api
          .crateApiNodeIirFilterIirFilterNodeGetFrequencyResponse(
              that: this,
  ...
  static Future<IirFilterNode> newInstance(
          {required C context,
          required IIRFilterOptions options,
          dynamic hint}) =>
      RustLib.instance.api.crateApiNodeIirFilterIirFilterNodeNew(
