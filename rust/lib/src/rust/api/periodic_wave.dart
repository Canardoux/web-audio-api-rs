...
class PeriodicWave extends RustOpaque {
  PeriodicWave.dcoDecode(List<dynamic> wire)
      : super.dcoDecode(wire, _kStaticData);

  PeriodicWave.sseDecode(BigInt ptr, int externalSizeOnNative)
  ...
  static Future<PeriodicWave> newInstance(
          ...
          dynamic hint}) =>
      RustLib.instance.api.crateApiPeriodicWavePeriodicWaveNew(
