...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1539457240;
...
fn wire__crate__api__context__online__AudioContextOptions_set_render_size_hint_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "AudioContextOptions_set_render_size_hint", port: None, mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync }, move || { 
            ...
            let mut deserializer = flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<AudioContextOptions>>>::sse_decode(&mut deserializer);
let api_render_size_hint = <AudioContextRenderSizeCategory>::sse_decode(&mut deserializer);deserializer.end();
                transform_result_sse((move || {
                    let mut api_that_decoded = None;
let decode_indices_ = flutter_rust_bridge::for_generated::rust_auto_opaque_decode_compute_order(vec![flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_that, 0, true)]);
        for i in decode_indices_ {
...
impl SseDecode for AudioContextRenderSizeCategory {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut inner = <RustOpaqueMoi<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<AudioContextRenderSizeCategory>,
...
66 => wire__crate__api__context__online__AudioContext_base_latency_impl(port, ptr, rust_vec_len, data_len),
67 => wire__crate__api__context__online__AudioContext_clear_onsinkchange_impl(port, ptr, rust_vec_len, data_len),
68 => wire__crate__api__context__online__AudioContext_close_impl(port, ptr, rust_vec_len, data_len),
69 => wire__crate__api__context__online__AudioContext_close_sync_impl(port, ptr, rust_vec_len, data_len),
70 => wire__crate__api__context__online__AudioContext_create_media_element_source_impl(port, ptr, rust_vec_len, data_len),
71 => wire__crate__api__context__online__AudioContext_create_media_stream_destination_impl(port, ptr, rust_vec_len, data_len),
72 => wire__crate__api__context__online__AudioContext_create_media_stream_source_impl(port, ptr, rust_vec_len, data_len),
73 => wire__crate__api__context__online__AudioContext_create_media_stream_track_source_impl(port, ptr, rust_vec_len, data_len),
74 => wire__crate__api__context__online__AudioContext_new_impl(port, ptr, rust_vec_len, data_len),
75 => wire__crate__api__context__online__AudioContext_output_latency_impl(port, ptr, rust_vec_len, data_len),
76 => wire__crate__api__context__online__AudioContext_render_capacity_impl(port, ptr, rust_vec_len, data_len),
77 => wire__crate__api__context__online__AudioContext_resume_impl(port, ptr, rust_vec_len, data_len),
78 => wire__crate__api__context__online__AudioContext_resume_sync_impl(port, ptr, rust_vec_len, data_len),
79 => wire__crate__api__context__online__AudioContext_run_diagnostics_impl(port, ptr, rust_vec_len, data_len),
80 => wire__crate__api__context__online__AudioContext_set_onsinkchange_impl(port, ptr, rust_vec_len, data_len),
81 => wire__crate__api__context__online__AudioContext_set_sink_id_sync_impl(port, ptr, rust_vec_len, data_len),
82 => wire__crate__api__context__online__AudioContext_sink_id_impl(port, ptr, rust_vec_len, data_len),
83 => wire__crate__api__context__online__AudioContext_suspend_impl(port, ptr, rust_vec_len, data_len),
84 => wire__crate__api__context__online__AudioContext_suspend_sync_impl(port, ptr, rust_vec_len, data_len),
85 => wire__crate__api__decoding__MediaDecoder_try_new_impl(port, ptr, rust_vec_len, data_len),
86 => wire__crate__api__decoding__MediaInput_new_impl(port, ptr, rust_vec_len, data_len),
87 => wire__crate__api__media_element__MediaElement_current_time_impl(port, ptr, rust_vec_len, data_len),
88 => wire__crate__api__media_element__MediaElement_loop__impl(port, ptr, rust_vec_len, data_len),
89 => wire__crate__api__media_element__MediaElement_new_impl(port, ptr, rust_vec_len, data_len),
90 => wire__crate__api__media_element__MediaElement_pause_impl(port, ptr, rust_vec_len, data_len),
91 => wire__crate__api__media_element__MediaElement_paused_impl(port, ptr, rust_vec_len, data_len),
92 => wire__crate__api__media_element__MediaElement_play_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__media_element__MediaElement_playback_rate_impl(port, ptr, rust_vec_len, data_len),
94 => wire__crate__api__media_element__MediaElement_set_current_time_impl(port, ptr, rust_vec_len, data_len),
95 => wire__crate__api__media_element__MediaElement_set_loop_impl(port, ptr, rust_vec_len, data_len),
96 => wire__crate__api__media_element__MediaElement_set_playback_rate_impl(port, ptr, rust_vec_len, data_len),
97 => wire__crate__api__message__OneshotNotify_send_impl(port, ptr, rust_vec_len, data_len),
98 => wire__crate__api__message_port__MessagePort_clear_onmessage_impl(port, ptr, rust_vec_len, data_len),
99 => wire__crate__api__message_port__MessagePort_post_message_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__message_port__MessagePort_set_onmessage_impl(port, ptr, rust_vec_len, data_len),
101 => wire__crate__api__param__AudioParam_automation_rate_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__param__AudioParam_cancel_and_hold_at_time_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__param__AudioParam_cancel_scheduled_values_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__param__AudioParam_default_value_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__param__AudioParam_exponential_ramp_to_value_at_time_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__param__AudioParam_linear_ramp_to_value_at_time_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__param__AudioParam_max_value_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__param__AudioParam_min_value_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__param__AudioParam_set_automation_rate_impl(port, ptr, rust_vec_len, data_len),
110 => wire__crate__api__param__AudioParam_set_target_at_time_impl(port, ptr, rust_vec_len, data_len),
111 => wire__crate__api__param__AudioParam_set_value_impl(port, ptr, rust_vec_len, data_len),
112 => wire__crate__api__param__AudioParam_set_value_at_time_impl(port, ptr, rust_vec_len, data_len),
113 => wire__crate__api__param__AudioParam_set_value_curve_at_time_impl(port, ptr, rust_vec_len, data_len),
114 => wire__crate__api__param__AudioParam_value_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__periodic_wave__PeriodicWave_new_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__resampling__Resampler_new_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__spatial__AudioListenerNode_into_fields_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__spatial__AudioListenerNode_new_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__spatial__angle_impl(port, ptr, rust_vec_len, data_len),
120 => wire__crate__api__spatial__audio_listener_forward_x_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__spatial__audio_listener_forward_y_impl(port, ptr, rust_vec_len, data_len),
122 => wire__crate__api__spatial__audio_listener_forward_z_impl(port, ptr, rust_vec_len, data_len),
123 => wire__crate__api__spatial__audio_listener_position_x_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__spatial__audio_listener_position_y_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__spatial__audio_listener_position_z_impl(port, ptr, rust_vec_len, data_len),
126 => wire__crate__api__spatial__audio_listener_up_x_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__spatial__audio_listener_up_y_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__spatial__audio_listener_up_z_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__spatial__azimuth_and_elevation_impl(port, ptr, rust_vec_len, data_len),
130 => wire__crate__api__spatial__distance_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        58 => wire__crate__api__context__online__AudioContextOptions_get_latency_hint_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        59 => wire__crate__api__context__online__AudioContextOptions_get_render_size_hint_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        60 => wire__crate__api__context__online__AudioContextOptions_get_sample_rate_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        61 => wire__crate__api__context__online__AudioContextOptions_get_sink_id_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        62 => wire__crate__api__context__online__AudioContextOptions_set_latency_hint_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        63 => wire__crate__api__context__online__AudioContextOptions_set_render_size_hint_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__api__context__online__AudioContextOptions_set_sample_rate_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        65 => wire__crate__api__context__online__AudioContextOptions_set_sink_id_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for FrbWrapper<AudioContextRenderSizeCategory> {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self.0)
            .into_dart()
    }
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for FrbWrapper<AudioContextRenderSizeCategory>
{
}

impl flutter_rust_bridge::IntoIntoDart<FrbWrapper<AudioContextRenderSizeCategory>>
    for AudioContextRenderSizeCategory
{
    fn into_into_dart(self) -> FrbWrapper<AudioContextRenderSizeCategory> {
        self.into()
    }
}
...
impl SseEncode for AudioContextRenderSizeCategory {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <RustOpaqueMoi<
            flutter_rust_bridge::for_generated::RustAutoOpaqueInner<AudioContextRenderSizeCategory>,
