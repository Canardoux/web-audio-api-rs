...
use crate::api::api::{AudioBuffer, AudioRenderCapacityEvent};
...
pub struct ErrorEvent {
    ...
    pub error: RustAutoOpaque<RustAutoOpaque<Box<dyn Any + Send>>>,
    /// Inherits from this base Event
    pub event: RustAutoOpaque<RustAutoOpaque<Event>>,
}
