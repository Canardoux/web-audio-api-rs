...
use crate::api::context::AudioContextLatencyCategory;
...
pub fn enumerate_devices_sync() -> Vec<MediaDeviceInfo> {
    crate::api::io::enumerate_devices_sync()
}
...
/// be used inside a [`MediaStreamAudioSourceNode`](crate::api::node::MediaStreamAudioSourceNode).
///
...
pub fn get_user_media_sync(constraints: MediaStreamConstraints) -> MediaStream {
    ...
    crate::api::io::build_input(options, channel_count)
}
*/
