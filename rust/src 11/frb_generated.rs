...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1884339748;
...
287 => wire__crate__api__render__quantum__Alloc_silence_impl(port, ptr, rust_vec_len, data_len),
288 => wire__crate__api__render__quantum__Alloc_with_capacity_impl(port, ptr, rust_vec_len, data_len),
289 => wire__crate__api__render__quantum__AudioRenderQuantum_channel_data_impl(port, ptr, rust_vec_len, data_len),
290 => wire__crate__api__render__quantum__AudioRenderQuantum_channel_data_mut_impl(port, ptr, rust_vec_len, data_len),
291 => wire__crate__api__render__quantum__AudioRenderQuantum_channels_impl(port, ptr, rust_vec_len, data_len),
292 => wire__crate__api__render__quantum__AudioRenderQuantum_channels_mut_impl(port, ptr, rust_vec_len, data_len),
293 => wire__crate__api__render__quantum__AudioRenderQuantum_is_silent_impl(port, ptr, rust_vec_len, data_len),
294 => wire__crate__api__render__quantum__AudioRenderQuantum_make_silent_impl(port, ptr, rust_vec_len, data_len),
295 => wire__crate__api__render__quantum__AudioRenderQuantum_number_of_channels_impl(port, ptr, rust_vec_len, data_len),
296 => wire__crate__api__render__quantum__AudioRenderQuantum_set_number_of_channels_impl(port, ptr, rust_vec_len, data_len),
297 => wire__crate__api__render__thread__RenderThread_new_impl(port, ptr, rust_vec_len, data_len),
298 => wire__crate__api__render__thread__RenderThread_render_impl(port, ptr, rust_vec_len, data_len),
299 => wire__crate__api__render__thread__RenderThread_render_audiobuffer_impl(port, ptr, rust_vec_len, data_len),
300 => wire__crate__api__render__thread__RenderThread_render_audiobuffer_sync_impl(port, ptr, rust_vec_len, data_len),
301 => wire__crate__api__resampling__Resampler_new_impl(port, ptr, rust_vec_len, data_len),
302 => wire__crate__api__simple__greet_impl(port, ptr, rust_vec_len, data_len),
303 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
304 => wire__crate__api__simple__init_tau_core_impl(port, ptr, rust_vec_len, data_len),
305 => wire__crate__api__simple__rust_set_log_level_impl(port, ptr, rust_vec_len, data_len),
306 => wire__crate__api__simple__trace_logger_impl(port, ptr, rust_vec_len, data_len),
307 => wire__crate__api__spatial__AudioListenerNode_into_fields_impl(port, ptr, rust_vec_len, data_len),
308 => wire__crate__api__spatial__AudioListenerNode_new_impl(port, ptr, rust_vec_len, data_len),
309 => wire__crate__api__spatial__angle_impl(port, ptr, rust_vec_len, data_len),
310 => wire__crate__api__spatial__audio_listener_forward_x_impl(port, ptr, rust_vec_len, data_len),
311 => wire__crate__api__spatial__audio_listener_forward_y_impl(port, ptr, rust_vec_len, data_len),
312 => wire__crate__api__spatial__audio_listener_forward_z_impl(port, ptr, rust_vec_len, data_len),
313 => wire__crate__api__spatial__audio_listener_position_x_impl(port, ptr, rust_vec_len, data_len),
314 => wire__crate__api__spatial__audio_listener_position_y_impl(port, ptr, rust_vec_len, data_len),
315 => wire__crate__api__spatial__audio_listener_position_z_impl(port, ptr, rust_vec_len, data_len),
316 => wire__crate__api__spatial__audio_listener_up_x_impl(port, ptr, rust_vec_len, data_len),
317 => wire__crate__api__spatial__audio_listener_up_y_impl(port, ptr, rust_vec_len, data_len),
318 => wire__crate__api__spatial__audio_listener_up_z_impl(port, ptr, rust_vec_len, data_len),
319 => wire__crate__api__spatial__azimuth_and_elevation_impl(port, ptr, rust_vec_len, data_len),
320 => wire__crate__api__spatial__distance_impl(port, ptr, rust_vec_len, data_len),
321 => wire__crate__api__toto__toto_impl(port, ptr, rust_vec_len, data_len),
322 => wire__crate__api__toto__zozo_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
