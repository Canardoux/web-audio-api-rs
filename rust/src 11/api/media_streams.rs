...
//use crate::api::api::AudioBuffer;
use crate::api::buffer::AudioBuffer;
use crate::api::api::FallibleBuffer;
...
impl MediaStreamTrack {
    ...
    pub fn iter(&self) -> MediaStreamTrackIter { // [LARPOUX]
    //pub fn iter(&self) -> impl Iterator<Item = FallibleBuffer> { // [LARPOUX]
