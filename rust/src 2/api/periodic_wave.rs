...
use crate::api::node::TABLE_LENGTH_USIZE;
...
/// - see also: [`OscillatorNode`](crate::api::node::OscillatorNode)
///
/// # Usage
///
/// ```no_run
...
mod tests {
    ...
    use crate::api::context::AudioContext;
    use crate::api::node::{TABLE_LENGTH_F32, TABLE_LENGTH_USIZE};
