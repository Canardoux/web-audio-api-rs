...
use crate::api::context::AudioNodeId;
use smallvec::{smallvec, SmallVec};

use super::{Alloc, AudioParamValues, AudioProcessor, AudioRenderQuantum, NodeCollection};
use crate::api::node::{ChannelConfigInner, ChannelCountMode, ChannelInterpretation};
use crate::api::render::AudioWorkletGlobalScope;
...
mod tests {
    use super::*;
    use crate::api::context::DESTINATION_NODE_ID;
    ...
    fn config() -> ChannelConfigInner {
        ChannelConfigInner {
            count: 2,
            count_mode: crate::api::node::ChannelCountMode::Explicit,
            interpretation: crate::api::node::ChannelInterpretation::Speakers,
        }
    }
