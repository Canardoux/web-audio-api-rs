...
use crate::api::context::{AudioContextRegistration, ConcreteBaseAudioContext};
use crate::api::events::{ErrorEvent, EventHandler, EventPayload, EventType};
...
/// (the object that lives the render thread). See the [`crate::api::worklet`] mod.
pub trait AudioNode {
    /// Handle of the associated [`BaseAudioContext`](crate::api::context::BaseAudioContext).
    ///
    ...
    /// The [`BaseAudioContext`](crate::api::context::BaseAudioContext) concrete type which owns this
    /// AudioNode.
