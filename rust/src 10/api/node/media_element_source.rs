...
use crate::api::resampling::Resampler;
...
pub struct MediaElementAudioSourceOptions<'a> {
    pub media_element: RustAutoOpaque<&'a mut MediaElement>,
}
...
/// - see also:
/// [`AudioContext::create_media_element_source`](crate::api::context::AudioContext::create_media_element_source)
///
/// # Usage
///
/// ```no_run
