...
use crate::api::events::{EventDispatch, EventHandler, EventLoop, EventType};
use crate::api::message::ControlMessage;
use crate::api::node::{AudioDestinationNode, AudioNode, AudioNodeOptions, ChannelConfig};
use crate::api::param::AudioParam;
use crate::api::render::AudioProcessor;
use crate::api::spatial::AudioListenerParams;

use crate::api::AudioListener;
...
/// [`AudioContext`](crate::api::context::AudioContext) and
/// [`OfflineAudioContext`](crate::api::context::OfflineAudioContext), and the `context()` method on
/// `AudioNode`s.
///
...
impl ConcreteBaseAudioContext {
    ...
    pub(super) fn new(
        ...
        let (listener_params, destination_channel_config) = {
            ...
            let listener = crate::api::spatial::AudioListenerNode::new(&base);
        ...
        if !offline {
            crate::api::node::load_hrtf_processor(sample_rate as u32);
        }
