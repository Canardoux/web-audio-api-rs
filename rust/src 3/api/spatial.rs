...
use crate::api::context::{AudioContextRegistration, BaseAudioContext};
use crate::api::node::{
    AudioNode, AudioNodeOptions, ChannelConfig, ChannelCountMode, ChannelInterpretation,
};
use crate::api::param::{AudioParam, AudioParamDescriptor, AudioParamInner, AutomationRate};
...
pub struct AudioListener {
    pub(crate) position_x: RustAutoOpaque<AudioParam>,
    pub(crate) position_y: RustAutoOpaque<AudioParam>,
    pub(crate) position_z: RustAutoOpaque<AudioParam>,
    pub(crate) forward_x: RustAutoOpaque<AudioParam>,
    pub(crate) forward_y: RustAutoOpaque<AudioParam>,
    pub(crate) forward_z: RustAutoOpaque<AudioParam>,
    pub(crate) up_x: RustAutoOpaque<AudioParam>,
    pub(crate) up_y: RustAutoOpaque<AudioParam>,
    pub(crate) up_z: RustAutoOpaque<AudioParam>,
}
...
pub(crate) struct AudioListenerParams {
    pub position_x: RustAutoOpaque<AudioParamInner>,
    pub position_y: RustAutoOpaque<AudioParamInner>,
    pub position_z: RustAutoOpaque<AudioParamInner>,
    pub forward_x: RustAutoOpaque<AudioParamInner>,
    pub forward_y: RustAutoOpaque<AudioParamInner>,
    pub forward_z: RustAutoOpaque<AudioParamInner>,
    pub up_x: RustAutoOpaque<AudioParamInner>,
    pub up_y: RustAutoOpaque<AudioParamInner>,
    pub up_z: RustAutoOpaque<AudioParamInner>,
}
